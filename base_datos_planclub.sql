...
--
ALTER TABLE `detalle_receta`
  ADD CONSTRAINT `fk_detalle_insumo` FOREIGN KEY (`id_insumo`) REFERENCES `insumo` (`ID_INSUMO`) ON UPDATE CASCADE,
  ADD CONSTRAINT `fk_detalle_receta_receta` FOREIGN KEY (`id_receta`) REFERENCES `recetas` (`id_receta`) ON UPDATE CASCADE;
...
ALTER TABLE `detalle_venta`
  ...
  ADD CONSTRAINT `FK_DETALLE_VENTA_VENTA` FOREIGN KEY (`ID_VENTA`) REFERENCES `venta` (`ID_VENTA`) ON UPDATE CASCADE;

--
-- Filtros para la tabla `incidencia`
--
ALTER TABLE `incidencia`
  ADD CONSTRAINT `fk_incidencia_usuario` FOREIGN KEY (`ID_USUARIO`) REFERENCES `usuario` (`ID_USUARIO`) ON UPDATE CASCADE;

--
-- Filtros para la tabla `mensajes`
--
ALTER TABLE `mensajes`
  ADD CONSTRAINT `fk_mensajes_usuario` FOREIGN KEY (`id_emisor`) REFERENCES `usuario` (`ID_USUARIO`) ON UPDATE CASCADE,
  ADD CONSTRAINT `fk_mensajes_usuario_receptor` FOREIGN KEY (`id_receptor`) REFERENCES `usuario` (`ID_USUARIO`) ON UPDATE CASCADE;

--
-- Filtros para la tabla `pago`
--
ALTER TABLE `pago`
  ADD CONSTRAINT `FK_PAGO_PEDIDO` FOREIGN KEY (`ID_PEDIDO`) REFERENCES `pedido` (`ID_PEDIDO`) ON UPDATE CASCADE;
...
ALTER TABLE `pedido`
  ...
  ADD CONSTRAINT `FK_PEDIDO_PRODUCTO` FOREIGN KEY (`ID_PRODUCTO`) REFERENCES `producto` (`ID_PRODUCTO`) ON UPDATE CASCADE,
...
--
ALTER TABLE `permisos_rol`
  ADD CONSTRAINT `fk_permisos_rol_permiso` FOREIGN KEY (`id_permiso`) REFERENCES `permisos` (`id_permiso`) ON UPDATE CASCADE,
  ADD CONSTRAINT `fk_permisos_rol_rol` FOREIGN KEY (`id_rol`) REFERENCES `rol` (`id_rol`) ON UPDATE CASCADE;

--
-- Filtros para la tabla `recetas`
--
ALTER TABLE `recetas`
  ADD CONSTRAINT `fk_resetas_producto` FOREIGN KEY (`id_producto`) REFERENCES `producto` (`ID_PRODUCTO`) ON UPDATE CASCADE;

--
-- Filtros para la tabla `reserva`
--
ALTER TABLE `reserva`
  ADD CONSTRAINT `FK_ID_MESA` FOREIGN KEY (`ID_MESA`) REFERENCES `mesa` (`ID_MESA`) ON DELETE CASCADE ON UPDATE CASCADE,
...
--
ALTER TABLE `reseña`
  ADD CONSTRAINT `fk_reseña_usuario` FOREIGN KEY (`ID_USUARIO`) REFERENCES `usuario` (`ID_USUARIO`) ON UPDATE CASCADE;

--
-- Filtros para la tabla `telefono`
--
ALTER TABLE `telefono`
  ADD CONSTRAINT `FK_TELEFONO_USUARIO` FOREIGN KEY (`ID_USUARIO`) REFERENCES `usuario` (`ID_USUARIO`) ON UPDATE CASCADE;
